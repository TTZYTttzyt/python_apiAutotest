...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(myTask12, ema_task, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_ema_task */
/**
* @brief Function implementing the myTask12 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ema_task */
__weak void ema_task(void const * argument)
{
